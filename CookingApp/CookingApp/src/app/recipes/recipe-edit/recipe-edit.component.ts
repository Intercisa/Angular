...
export class RecipeEditComponent implements OnInit {
  ...
  onSubmit(){
    ...
    if(this.editMode)
      this.recipeService.updateRecipe(this.id, this.recipeForm.value); // because this is in the same format 
    else
      this.recipeService.addRecipe(this.recipeForm.value);  // because this is in the same format 
